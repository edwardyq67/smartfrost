...
const EmpresasAgregarDialog = dynamic(
  () => import("./components/EmpresasAgregar").then(mod => ({
    default: ({ onEmpresaCreada }: { onEmpresaCreada: () => void }) => (
      <DialogContent overflowVisible={true} size="3xl">
        ...
        <mod.EmpresasAgregar onEmpresaCreada={onEmpresaCreada} />
      </DialogContent>
    )
  })),
  {
...
const DataTablePage = () => {
  ...
  const { refreshTrigger } = useRefreshTableEmpresas();
  const { hasSpecificRoute } = useModulePermissions("empresas");
  
  const hasCreatePermission = hasSpecificRoute("POST", "empresas/crear");
          ...
          {hasCreatePermission && (
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <Suspense fallback={
                ...
                <EmpresasAgregarDialog onEmpresaCreada={handleEmpresaCreada} />
              </Suspense>
            </Dialog>
          )}
        </CardHeader>
          ...
          <Suspense fallback={
            <div className="p-8 text-center">
              <div className="inline-flex items-center justify-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-700">Cargando lista de empresas</p>
